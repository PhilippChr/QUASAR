...
import quasar.question_understanding.structured_representation.dataset_structured_representation as dataset
...
class StructuredRepresentationModel(torch.nn.Module):
    ...
    def train(self, train_path, dev_path):
        ...
        training_args = transformers.Seq2SeqTrainingArguments(
            output_dir=f"quasar/question_understanding/structured_representation/results_{self.config['name']}",  # output directory
            ...
            logging_dir="quasar/question_understanding/structured_representation/logs",  # directory for storing logs
            logging_steps=1000,
            eval_strategy="epoch",
            save_strategy="epoch",
