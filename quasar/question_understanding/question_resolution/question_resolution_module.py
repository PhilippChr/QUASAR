...
import quasar.question_understanding.question_resolution.question_resolution_utils as qres_utils
...
class QuestionResolutionModule(QuestionUnderstanding):
    def __init__(self, config, use_gold_answers):
        ...
        self.path_to_quretec = "quasar/question_understanding/question_resolution/quretec"
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        raise Exception(
            "Usage: python quasar/question_understanding/question_resolution/question_resolution_module.py --<FUNCTION> <PATH_TO_CONFIG>"
        )
