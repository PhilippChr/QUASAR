...
from quasar.evidence_retrieval_scoring.wikipedia_retriever.evidence_annotator import (
    EvidenceAnnotator,
)
from quasar.evidence_retrieval_scoring.wikipedia_retriever.infobox_parser import (
    InfoboxParser,
    infobox_to_evidences,
)
from quasar.evidence_retrieval_scoring.wikipedia_retriever.table_parser import (
    extract_wikipedia_tables,
    json_tables_to_evidences,
)
from quasar.evidence_retrieval_scoring.wikipedia_retriever.text_parser import (
    extract_text_snippets,
)
from quasar.library.utils import get_config, get_logger
