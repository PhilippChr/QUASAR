...
from quasar.clocq_client import CLOCQInterfaceClient
from quasar.evidence_retrieval_scoring.wikipedia_retriever.wikipedia_retriever import (
    WikipediaRetriever,
)
...
class ClocqRetriever:
    ...
    def retrieve_evidences_from_kb(self, item):
        ...
        facts = self.clocq.get_neighborhood(
            item["id"], p=self.config["clocq_p"], include_labels=True, include_type=True
        )
